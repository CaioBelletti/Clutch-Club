...
def system_gate(guild_id:int,x_admin_key:str|None=Header(default=None)):
    ...
    with Session() as s:
        ...
        ck('Version Consistency',True,'Backend/Web/Core V3.7.5 · Recovery V3.4.5 one-shot')
